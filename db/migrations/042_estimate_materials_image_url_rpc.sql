-- ============================================================================
-- Migration: 042_estimate_materials_image_url_rpc
-- Description: Add imageUrl to the returned jsonb by joining directory_materials
-- Date: 2026-05-22
-- ============================================================================

-- ----------------------------------------------------------------------------
-- Update: create_estimate_section
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Update: add_work_from_directory_to_estimate
-- ----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION public.add_work_from_directory_to_estimate(
  p_workspace_owner_id uuid,
  p_project_id uuid,
...
-- ----------------------------------------------------------------------------
-- Update: add_material_from_directory_to_estimate
-- ----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION public.add_material_from_directory_to_estimate(
  p_workspace_owner_id uuid,
  p_project_id uuid,
...
-- ----------------------------------------------------------------------------
-- Update: archive_estimate_section
-- ----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION public.archive_estimate_section(
  p_workspace_owner_id uuid,
  p_project_id uuid,
...
-- ----------------------------------------------------------------------------
-- Update: archive_estimate_material
-- ----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION public.archive_estimate_material(
  p_workspace_owner_id uuid,
  p_project_id uuid,
