-- ============================================================================
-- Migration: 043_estimate_materials_classical_consumption
-- Description: Transition material calculations to the classical formula:
--   Quantity = Work Quantity * Consumption
--   Consumption = Quantity / Work Quantity (when Work Quantity > 0)
-- Date: 2026-05-22
-- ============================================================================

-- 1. Update recalculate_materials_by_work_quantity to classical formula: Work * Consumption
...
BEGIN
  ...
  SET quantity = round((p_work_quantity * consumption)::numeric, 3),
...
-- 2. Update add_material_from_directory_to_estimate with classical formulas
...
BEGIN
  ...
  ELSIF p_changed_field = 'quantity' THEN
    ...
    v_resolved_consumption = CASE
      ...
      THEN round((COALESCE(p_quantity, 0) / v_work.quantity)::numeric, 6)
      ELSE NULL
    END;
  ELSE
    v_resolved_quantity = round(COALESCE(p_quantity, 0)::numeric, 3);
