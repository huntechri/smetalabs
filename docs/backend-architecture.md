...
- **[project-estimate-content-architecture.md](./project-estimate-content-architecture.md)** — хранение разделов, работ и материалов сметы проекта: структура разделов, копирование значений из справочников, порядок строк и итоги.
