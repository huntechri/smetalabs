...
>
> **Последняя проверка:** 2026-05-18 — актуально. Все 36 компонентов `components/ui/` задокументированы. Добавлен Spinner.
...
Индикатор загрузки. Используется для состояний ожидания данных.
