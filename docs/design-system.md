...
>
> **Последняя проверка:** 2026-05-12 22:00 UTC — актуально. Все 35 компонентов `components/ui/` задокументированы. Switch, EditableBadge, Frame, FramedButton добавлены. Фичи: account-settings (6 карточек), workspace-settings (16 компонентов, включая 4 диалога подтверждения). Auth-illustration и invite-password-form добавлены.
