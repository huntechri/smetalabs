...
>
> **Последняя проверка:** 2026-05-10 — актуально, все компоненты из `components/ui/` задокументированы. Добавлены фичи: directory-suppliers, directory-counterparties.
...
<SidebarProvider defaultOpen={true}>
  ...
  <SidebarInset>
    ...
    <main className="flex-1 overflow-auto p-4 scrollbar-subtle">
      {children}
    </main>
  </SidebarInset>
</SidebarProvider>
...
<div className="flex h-full gap-0">
  <div className="w-80 border-r p-4 overflow-auto scrollbar-subtle">
    {/* List of items */}
  </div>
  <div className="flex-1 overflow-auto p-4 scrollbar-subtle">
    {/* Detail view */}
  </div>
</div>
```
