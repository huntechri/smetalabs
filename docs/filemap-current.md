# SmetaLabs — Current Filemap

> Last updated: 2026-05-12
>
> This is the compact current map. The older long-form filemap remains in [`docs/filemap.md`](./filemap.md), but new agents and contributors should start here.
