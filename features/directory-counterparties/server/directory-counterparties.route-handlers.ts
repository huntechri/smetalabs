...
export function handleDirectoryCounterpartiesRouteError(
  err: unknown,
  routeLabel: string
) {
  if (err instanceof DirectoryCounterpartiesApiError)
...
export async function handleDirectoryCounterpartiesListRequest(
  request: NextRequest
) {
  try {
    const params = parseDirectoryCounterpartiesListParams(
      request.nextUrl.searchParams
    )
    const response = await listDirectoryCounterparties(params)
    return NextResponse.json(response)
  } catch (err) {
    return handleDirectoryCounterpartiesRouteError(
      err,
      "[GET /api/directory-counterparties]"
    )
  }
}

export async function handleDirectoryCounterpartyCreateRequest(
  request: NextRequest
) {
  try {
    ...
    return handleDirectoryCounterpartiesRouteError(
      err,
      "[POST /api/directory-counterparties]"
    )
  }
}
...
export async function handleDirectoryCounterpartyDetailRequest(id: string) {
  try {
    ...
    return handleDirectoryCounterpartiesRouteError(
      err,
      "[GET /api/directory-counterparties/[id]]"
    )
  }
}

export async function handleDirectoryCounterpartyUpdateRequest(
  request: NextRequest,
  id: string
) {
  try {
    ...
    return handleDirectoryCounterpartiesRouteError(
      err,
      "[PATCH /api/directory-counterparties/[id]]"
    )
  }
}
...
export async function handleDirectoryCounterpartyArchiveRequest(id: string) {
  try {
    ...
    return handleDirectoryCounterpartiesRouteError(
      err,
      "[DELETE /api/directory-counterparties/[id]]"
    )
  }
}
