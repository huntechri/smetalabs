...
const directoryMaterialsSortSchema = z.enum(["relevance", "updated_desc", "name_asc"]).default("relevance")
...
const importRowsSchema = z.array(z.record(z.string(), z.unknown())).max(MAX_IMPORT_BATCH_ROWS, `За один пакет можно загрузить не больше ${MAX_IMPORT_BATCH_ROWS} строк`).default([])
...
export const directoryMaterialMutationSchema = z.object({
...
export const directoryMaterialImportCreateSchema = z.object({
...
export const directoryMaterialImportBatchSchema = z.object({
...
export const directoryMaterialImportApplySchema = z.object({
...
export const directoryMaterialAiSearchSchema = z.object({
...
export const directoryMaterialEmbeddingProcessSchema = z.object({ limit: directoryMaterialEmbeddingLimitSchema }).strict()
export const directoryMaterialIdSchema = z.string().uuid()
export const directoryMaterialCategoryStatusSchema = z.enum(["active", "archived"]).default("active")
...
export function parseDirectoryMaterialMutationBody(body: unknown) { return directoryMaterialMutationSchema.parse(body) }
export function parseDirectoryMaterialImportCreateBody(body: unknown) { return directoryMaterialImportCreateSchema.parse(body) }
export function parseDirectoryMaterialImportBatchBody(body: unknown) { return directoryMaterialImportBatchSchema.parse(body) }
...
export function parseDirectoryMaterialAiSearchBody(body: unknown) { return directoryMaterialAiSearchSchema.parse(body) }
export function parseDirectoryMaterialEmbeddingProcessBody(body: unknown) { return directoryMaterialEmbeddingProcessSchema.parse(body) }
export function parseDirectoryMaterialId(id: string) { return directoryMaterialIdSchema.parse(id) }
export function parseDirectoryMaterialCategoryStatus(value: string | null) { return directoryMaterialCategoryStatusSchema.parse(value ?? undefined) }
