...
export function DirectorySuppliersRow({
  row,
  saving,
  onArchive,
  onEdit,
}: {
  row: DirectorySupplier
  saving: boolean
  onArchive: (row: DirectorySupplier) => void
  onEdit: (row: DirectorySupplier) => void
}) {
  return (
    <div className="mx-3 my-1.5 grid gap-3 rounded-md border border-border p-3 transition-colors hover:bg-muted/50 lg:grid-cols-[minmax(320px,1fr)_minmax(560px,0.9fr)]">
