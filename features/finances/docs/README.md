...
Вкладка «Финансы» в карточке сметы. Отображает финансовую аналитику: KPI-карточки (Договор / Оплачено / Остаток / Закупки) и таблицу платежей с группировкой по разделам сметы.
...
- [x] KPI-шапка (Договор, Оплачено, Остаток, Закупки)
