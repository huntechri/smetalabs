...
function estimateOptionsCacheTag(
...
function revalidateEstimateContent(
  workspaceOwnerId: string,
  projectId: string
) {
...
export async function getProjectEstimateContent(
  projectId: string,
  recordId: string
) {
...
export async function listProjectEstimateWorkOptions(
  ...
  return unstable_cache(
    ...
    ],
    {
      ...
      tags: [
        estimateOptionsCacheTag(context.workspaceOwnerId, projectId, recordId),
      ],
    }
  )()
}
...
export async function listProjectEstimateMaterialOptions(
  ...
  return unstable_cache(
    ...
    [
      "project-estimate-material-options",
      context.workspaceOwnerId,
      projectId,
      recordId,
      JSON.stringify(params),
