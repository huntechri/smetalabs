...
export function PurchaseRow({
  ...
  const canEdit = row.editable && typeof onUpdate === "function" && editablePurchaseId !== null
  const canArchive = row.editable && typeof onArchive === "function" && editablePurchaseId !== null
