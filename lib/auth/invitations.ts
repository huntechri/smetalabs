...
type AcceptInvitationResult =
  ...
  | { success: false; reason: 'no_user' | 'no_invitation_metadata' | 'not_found' | 'expired' | 'email_mismatch' }
 ...
 */
export async function acceptInvitationIfPresent(userId: string): Promise<AcceptInvitationResult> {
