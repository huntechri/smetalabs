...
const DOC_EXPECT = {
  ...
  'directory-materials': { expectedLayers: ['components','hooks','api-client','api-routes','server','types'], expectedFiles: ['features/directory-materials/components/directory-materials-view.tsx','features/directory-materials/hooks/use-directory-materials.ts','features/directory-materials/api/directory-materials-client.ts','features/directory-materials/server/directory-materials.service.ts'] },
